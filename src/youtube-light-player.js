  ...
  attributeChangedCallback(attrName) {
    if (attrName === 'src') {
      ...
      shadow.innerHTML =
        ...
        `
          <div class="video">
            <img class="video__thumbnail" src="https://i.ytimg.com/vi_webp/${this.videoId}/sddefault.webp">
      ...
      const playVideo = () => {
        shadow.innerHTML =
          ...
          `
          <div class="video"> 
            <iframe class="video__embed" type="text/html" frameborder="0" allow="autoplay; encrypted-media; picture-in-picture"
                    src="https://www.youtube.com/embed/${this.videoId}?autoplay=1&rel=0&modestbranding=1&playsinline=1&iv_load_policy=3"></iframe>
          <div>
          <style>
            .video{
              position: relative; 
